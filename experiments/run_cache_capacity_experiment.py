...
def main() -> None:
    ...
    write_run_metadata(
        base_config,
        data_dir / "cache_capacity_experiment_metadata.json",
        run_name="cache_capacity_experiment",
        extra_metadata={
            "sweep_parameter": "cache_capacity",
            "sweep_values": cache_capacities,
            "output_files": [
                "results/data/cache_capacity_experiment.csv",
                "results/figures/latency_vs_cache_capacity.png",
                "results/figures/hit_ratio_vs_cache_capacity.png",
            ],
        },
    )
