...
def main() -> None:
    ...
    write_run_metadata(
        base_config,
        data_dir / "user_density_experiment_metadata.json",
        run_name="user_density_experiment",
        extra_metadata={
            "sweep_parameter": "num_users",
            "sweep_values": user_counts,
            "output_files": [
                "results/data/user_density_experiment.csv",
                "results/figures/latency_vs_num_users.png",
                "results/figures/rate_vs_num_users.png",
            ],
        },
    )
