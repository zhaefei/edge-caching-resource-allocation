...
def main() -> None:
    ...
    write_run_metadata(
        base_config,
        data_dir / "bandwidth_sensitivity_experiment_metadata.json",
        run_name="bandwidth_sensitivity_experiment",
        extra_metadata={
            "sweep_parameter": "bandwidth_mhz",
            "sweep_values": bandwidth_mhz_values,
            "output_files": [
                "results/data/bandwidth_sensitivity_experiment.csv",
                "results/figures/latency_vs_bandwidth.png",
                "results/figures/rate_vs_bandwidth.png",
            ],
        },
    )
