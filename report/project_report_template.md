...
After the learning baseline is implemented, describe it as a UCB-style
combinatorial semi-bandit rather than a novel reinforcement-learning algorithm.
Each edge server treats files as arms, selects a capacity-feasible cache once
per training epoch, and learns from the avoided backhaul delay of selected
files. Explain the reward-density score, fixed random seed, and chronological
training/evaluation split. Do not add MAB numerical claims until they have been
generated by the comparison experiment.
