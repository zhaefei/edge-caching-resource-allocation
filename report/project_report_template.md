...
split. Use only values generated by the dedicated comparison script, and label
the Iteration 9 result as a single-seed observation until the multi-seed study
has been completed.
